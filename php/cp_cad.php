...
var_dump($_POST["id_perito"], $_POST["id_processo"]);
if (isset($_POST["cadastrar"], $_POST["id_perito"], $_POST["id_processo"],$_POST["data_dia"], $_POST["entrada_manha"], $_POST["entrada_tarde"], $_POST["entrada_noite"],
