...
CREATE TABLE pointcards (
    ...
    id_process character varying NOT NULL,
    date_day date NOT NULL,
    morning_entry integer,
    late_entry integer,
    night_entry integer,
    daily_rest_worked integer,
    morning_departure integer,
    afternoon_departure integer,
    night_departure integer,
    nocturnal_rest_worked integer,
    extra_hour_daily1 integer,
    extra_hour_daily2 integer,
    extra_hour_daily3 integer,
    night_overtime1 integer,
    night_overtime2 integer,
    night_overtime3 integer,
    total_daily_time integer,
